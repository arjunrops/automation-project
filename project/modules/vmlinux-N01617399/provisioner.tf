...
resource "null_resource" "ansible_provisioner" {
  ...
  provisioner "local-exec" {
    command = "ansible-playbook -i /home/arjunsinghroperia/automation/automation-project/project/ansible/linux_hosts /home/arjunsinghroperia/automation/automation-project/project/ansible/n01617399-playbook.yml"
  }
